...
#filtrar a coluna trip distance e usar a funcao quantile para o percentil de 0.9.
percentil_90 = df['trip_distance'].quantile(0.9)

#filtrar a coluna trip distance e filtrar tudo acima de 0.9.
trips_above_90_percentile = df[df['trip_distance'] > percentil_90]
